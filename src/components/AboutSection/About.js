        ...
        <div className="flex">
          ...
          <span className="pinkFont">
            ...
            <span className="orangeFont">
              <span className="blueFont">{"["}</span>'Angular', 'React', 'SQL',
              'NoSQL', 'Node.js/express.js', 'Socket.io', 'SCSS', 'JSON',
              'Python/Numpy/Pandas/SKlearn/Matplotlib', 'C++/C/C#', 'Unity',
              'Git Version Control', 'Linux/Unix enviroment', 'Flutter',
              'Tensorflow/Keras' <span className="flashingCursor"></span>
